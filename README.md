...
To build the final jar and optimize the rfidh2LiveTest application for production, run:
...
Then navigate to [http://localhost:9193](http://localhost:9193) in your browser.
